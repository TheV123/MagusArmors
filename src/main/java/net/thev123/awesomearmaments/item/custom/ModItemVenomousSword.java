...
public class ModItemVenomousSword extends SwordItem {
    private final float EFFECT_CHANCE =  0.2f;
    public ModItemVenomousSword(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
