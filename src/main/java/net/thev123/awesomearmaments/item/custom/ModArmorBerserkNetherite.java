...
public class ModArmorBerserkNetherite extends ArmorItem{
    private final Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;
    public ModArmorBerserkNetherite(ArmorMaterial material, Type type, Settings settings) {
        ...
        builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier("Attack  modifier", 0.5, EntityAttributeModifier.Operation.ADDITION));
    ...
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>()
                    .put(ModArmorMaterials.BERSERK_NETHERITE, new StatusEffectInstance(StatusEffects.SPEED, 200, 0))
                    .build();
    @Override
