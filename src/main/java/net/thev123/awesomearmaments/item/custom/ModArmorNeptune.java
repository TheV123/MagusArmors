...
public class ModArmorNeptune extends ArmorItem{
    ...
    public ModArmorNeptune(ArmorMaterial material, ArmorItem.Type type, Item.Settings settings) {
        super(material, type, settings);
    }
    //effects
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP1 =
            new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>()
                    .put(ModArmorMaterials.NEPTUNE, new StatusEffectInstance(StatusEffects.CONDUIT_POWER, effectDuration, amplifier))
                    .build();
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP2 =
            new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>()
                    .put(ModArmorMaterials.NEPTUNE, new StatusEffectInstance(StatusEffects.DOLPHINS_GRACE, effectDuration, amplifier))
                    .build();
    @Override
