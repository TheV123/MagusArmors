...
public class ModArmorAquaDiamond extends ArmorItem{
    ...
    public ModArmorAquaDiamond(ArmorMaterial material, Type type, Settings settings) {
        ...
        //attributes
        int protection = ModArmorMaterials.AQUA_DIAMOND.getProtection(type);
        float toughness = ModArmorMaterials.AQUA_DIAMOND.getToughness();
        float knockbackResistance = ModArmorMaterials.AQUA_DIAMOND.getKnockbackResistance();

        ImmutableMultimap.Builder<EntityAttribute, EntityAttributeModifier> builder =
                ImmutableMultimap.builder();
        builder.put(EntityAttributes.GENERIC_ARMOR, new EntityAttributeModifier("Armor modifier", protection,
                EntityAttributeModifier.Operation.ADDITION));
        builder.put(EntityAttributes.GENERIC_ARMOR_TOUGHNESS, new EntityAttributeModifier(
                "Armor toughness", toughness, EntityAttributeModifier.Operation.ADDITION));
        ...
        builder.put(EntityAttributes.GENERIC_MOVEMENT_SPEED, new EntityAttributeModifier(
                "Speed modifier", -0.005, EntityAttributeModifier.Operation.ADDITION));
    ...
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP1 =
            new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>()
                    .put(ModArmorMaterials.BULWARK, new StatusEffectInstance(StatusEffects.RESISTANCE, 200, 0))
                    .build();
