...
public class ModArmorBerserkDiamond extends ArmorItem{
    public static final int effectDuration = 200;
    public static final int amplifier = 0;
    public ModArmorBerserkDiamond(ArmorMaterial material, Type type, Settings settings) {
        super(material, type, settings);
    }
    //effects
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP1 =
            new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>()
                    .put(ModArmorMaterials.BERSERK_DIAMOND, new StatusEffectInstance(StatusEffects.SPEED, effectDuration, amplifier))
                    .build();
    @Override
