...
public class ModArmorWiseDiamond extends ArmorItem {
    ...
    public ModArmorWiseDiamond(ArmorMaterial material, ArmorItem.Type slot, Settings settings) {
    ...
    private void evaluateArmorEffects(PlayerEntity player) {
        for (Map.Entry<ArmorMaterial, StatusEffectInstance> entry : MATERIAL_TO_EFFECT_MAP.entrySet()) {
            ArmorMaterial mapArmorMaterial = ModArmorMaterials.WISE_DIAMOND;
            StatusEffectInstance mapStatusEffect = new StatusEffectInstance(ModEffects.EXPERIENCE_EMPOWER,
