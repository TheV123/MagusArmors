...
public class ModItemWitheringSword extends SwordItem {
    private final float EFFECT_CHANCE =  0.2f;
    public ModItemWitheringSword(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
