...
public class ModItemVenomousAxe extends AxeItem {
    private final float EFFECT_CHANCE =  0.3f;
    public ModItemVenomousAxe(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
